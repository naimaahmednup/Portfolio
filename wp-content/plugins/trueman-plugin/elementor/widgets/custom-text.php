...
/**
 * Trueman Custom Text Widget.
 *
 * @since 1.0
 */
class Trueman_Custom_Text_Widget extends Widget_Base {

	public function get_name() {
		return 'trueman-custom-text';
	}

	public function get_title() {
		return esc_html__( 'Custom Text', 'trueman-plugin' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Enter your text', 'trueman-plugin' ),
				'default'     => esc_html__( 'Type your text here', 'trueman-plugin' ),
			]
		);
...
Plugin::instance()->widgets_manager->register( new Trueman_Custom_Text_Widget() );
